...
def mainRun():
    ...
    '''
    # MUSCython imports are deferred to here so the module is importable
    # without compiled Cython extensions (e.g. for tests that only need MUS).
    ...
    if args.subparserID == 'cffq':
        ...
        # text mode with newline='': on Windows this avoids writing '\r\n' line
        # endings, preserving the Linux byte contract of the CSV output.
        output = open(args.outputFile, 'w', newline='')
