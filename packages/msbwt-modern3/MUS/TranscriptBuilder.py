...
class Assembler(object):
    ...
    def extendSeed(self, seedKmer, endSeeds):
        ...
        if seedKmer in self.foundKmers:
            return
        ...
        if trackPairs:
            ...
            for node in self.nodes[firstID:]:
                ...
                for dID, direction in dIDs:
                    ...
                    if (oFID, rID, 1-direction) in self.abtDict:
                    ...
                    if (fID, rID, direction) not in self.abtDict:
