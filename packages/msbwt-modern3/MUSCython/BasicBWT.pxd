...
cdef class BasicBWT(object):
    ...
    cpdef unsigned long countOccurrencesOfSeq(BasicBWT self, object seq, tuple givenRange=*)
    ...
    cpdef list findKmerWithError(BasicBWT self, object seq, unsigned long minThresh=*)
    cpdef list findKmerWithErrors(BasicBWT self, object seq, unsigned long editDistance, unsigned long minThresh=*)
